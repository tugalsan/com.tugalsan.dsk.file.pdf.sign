...
public class PropertyProvider {
     ...
     */
    public static final String PROPERTY_FILE = Path.of("").toAbsolutePath().toString() + "/settings.properties";
    ...
    public void loadProperties(String aFileName) throws ProperyProviderException {
        if (aFileName != null) {
            ...
            LOGGER.info(PropertyProvider.class.getSimpleName() + "PropertyProvider.loadProperties: " + file.toString());
            loadProperties(file);
        } else {
     ...
     *
     * @param aKey property name which must be included in properties, if not
     * exception is thrown
